...
_BLUveh = ["B_MRAP_01_hmg_F","B_MBT_01_cannon_F"];
_OPFveh = ["O_MRAP_02_gmg_F","O_MRAP_02_hmg_F","O_APC_Wheeled_02_rcws_F","O_APC_Tracked_02_cannon_F","O_APC_Tracked_02_AA_F"];
_INDveh = ["I_MRAP_03_hmg_F","I_G_Offroad_01_armed_F","I_MBT_03_cannon_F","I_APC_Wheeled_03_cannon_F","I_APC_Wheeled_03_cannon_F"];
