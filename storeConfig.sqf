...
[
	...
	["ASP-1 Kir Rifle (Black) [DLC]", "srifle_DMR_04_F", 3000], // DLC Sniper Rifle
	["ASP-1 Kir Rifle (Tan) [DLC]", "srifle_DMR_04_Tan_F", 3000], // DLC Sniper Rifle
...
[
	...
	["Safe (PIN IS EMPTY) !!BETA!!", "Box_NATO_AmmoVeh_F", 50000, "ammocrate"],
