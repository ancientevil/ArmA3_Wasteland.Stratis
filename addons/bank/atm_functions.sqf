...
// Uncomment the above part and comment the below part if you haven't added ATM's yourself.
atm_is_object_atm = {
  ARGVX4(0,_object,objNull,false);
    
  if (_object isKindOf "Land_Atm_02_F") exitWith {true};
  if (_object isKindOf "Land_Atm_01_F") exitWith {true};
