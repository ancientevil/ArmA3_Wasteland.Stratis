...
[] spawn {
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBar")displayCtrl 1000)ctrlSetText format["TEAMSPEAK: TS.NL-UNITED.NL | PLAYERS ONLINE: %2 | AVERAGE FPS: %1", round diag_fps, count playableUnits];
	}; 
};